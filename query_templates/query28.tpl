...
define _LIMIT=100;
 define _BEGIN="#QUERY_28"; 
 define _END="";

[_LIMITA] select [_LIMITB] B1_LP,B1_CNT, B1_CNTD, B2_LP,B2_CNT, B2_CNTD, B3_LP,B3_CNT, B3_CNTD, B4_LP,B4_CNT, B4_CNTD, B5_LP,B5_CNT, B5_CNTD, B6_LP,B6_CNT, B6_CNTD
